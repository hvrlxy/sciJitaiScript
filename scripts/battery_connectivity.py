...
test.plotting_battery(subject='use004', date='2023-04-23')
# test.plotting_battery(subject='user06', date='2023-04-22')
# test.plotting_battery(subject='user06', date='2023-04-21')